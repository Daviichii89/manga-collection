...
describe('SearchComponent', () => {
  it('Should all the elements in the component', () => {
    ...
    expect(screen.getByPlaceholderText('Search for your mangas...')).toBeInTheDocument();
  ...
  it('Should on click button clear the input value', () => {
    ...
    const inputElement = screen.getByPlaceholderText('Search for your mangas...') as HTMLInputElement;
